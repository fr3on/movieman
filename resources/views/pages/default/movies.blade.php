...
@section('title', trans('website.movies'))

@section('content')
   <div class="page_c shi__border-top {{ Request::fullUrl() == env('APP_URL') . 'movies?type=tv' ? 'ptb-m' : '' }}">
      <div class="row">
         @if (count($movies) > 0)
            ...
            <div class="show__item">
               ...
               <div class="show__item-hover">
                  ...
                  <div class="show__item-hoverinfo float-left">
                     ...
                     @if(Request::fullUrl() == env('APP_URL') . 'movies?type=tv')
